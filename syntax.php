...
class syntax_plugin_navigation extends DokuWiki_Syntax_Plugin
{
    ...
    {
        $this->Lexer->addSpecialPattern('<FIXME>', $mode, 'plugin_navigation');
//        $this->Lexer->addEntryPattern('<FIXME>', $mode, 'plugin_navigation');
    }

//    public function postConnect()
//    {
//        $this->Lexer->addExitPattern('</FIXME>', 'plugin_navigation');
//    }
